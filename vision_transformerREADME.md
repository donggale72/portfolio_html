...
하지만, 비전분야에서는 Convolutional 구조가 아직까지 우세하게 사용되어왔다.<br>
...
본 논문에서도 NLP에 영감을 받아 standard transformer를 최소한의 수정으로 직접 이미지에 적용하는 것에 대해 실험을 했다
...
두번째 표에서 성능을 살펴보면 CNN 모델에 비해 성능이 좋았으며 특히, 학습 시간도 절약되었음을 알 수있다.<br> 
